...
test.describe('OAuth Analytics Dashboard', () => {
  test('should load and display analytics dashboard', async ({ page }) => {
    ...
    await expect(page.getByText('OAuth Analytics')).toBeVisible({ timeout: 10000 })
  })
  ...
  test('should handle loading state', async ({ page }) => {
    ...
    await expect(page.getByText(/loading metrics/i)).toBeVisible({ timeout: 2000 })
  ...
  test('should handle error state gracefully', async ({ page }) => {
    ...
    await expect(page.getByText(/failed to load metrics/i)).toBeVisible({ timeout: 5000 })
  ...
  test('should show auto-refresh indicator when enabled', async ({ page }) => {
    ...
    const autoRefreshBadge = page.getByText(/auto-refresh/i)
