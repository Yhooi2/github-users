...
test.describe('Session Expiration Mid-Use', () => {
  test('should gracefully fallback to demo mode when session expires', async ({ page, context }) => {
  ...
  test('should handle session expiration without breaking app', async ({ page, context }) => {
    // 1. Set up authenticated session
    await setupAuthenticatedSession(context)
    await mockAuthenticatedResponse(page)
  ...
  test('should show demo mode rate limit after session expires', async ({ page, context }) => {
  ...
  test('should handle multiple session expirations gracefully', async ({ page, context }) => {
