...
describe("calculateGrowthScore", () => {
  describe("insufficient data", () => {
    ...
    it("returns 0 score for single year (no YoY comparison)", () => {
      const timeline = [
        createYearData(2025, 100, [createRepoContribution("repo1", 10, 5)], []),
      ];
    ...
    it("awards positive points for increased stars and forks", () => {
      const timeline = [
        createYearData(
          2025,
          100,
          [createRepoContribution("repo1", 200, 40)],
          [],
        ),
        createYearData(
          2024,
          100,
          [createRepoContribution("repo1", 100, 20)],
          [],
        ),
      ];
      const result = calculateGrowthScore(timeline);
    ...
    it("awards negative points for decreased stars and forks", () => {
      const timeline = [
        createYearData(
          2025,
          100,
          [createRepoContribution("repo1", 50, 10)],
          [],
        ),
        createYearData(
          2024,
    ...
    it("averages stars and forks growth", () => {
      const timeline = [
        createYearData(
          2025,
          100,
          [createRepoContribution("repo1", 200, 20)],
          [],
        ), // stars +100%, forks 0%
        createYearData(
          2024,
    ...
    it("caps impact growth at maximum weight (30 points)", () => {
      const timeline = [
        createYearData(
          2025,
          100,
          [createRepoContribution("repo1", 10000, 1000)],
          [],
        ),
        createYearData(
          2024,
          100,
          [createRepoContribution("repo1", 100, 10)],
          [],
        ),
      ];
      const result = calculateGrowthScore(timeline);
    ...
    it("aggregates stars/forks across multiple repos", () => {
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution("repo1", 100, 10),
            createRepoContribution("repo2", 100, 10),
          ],
          [],
        ),
    ...
    it("ignores repos with no primary language", () => {
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution("repo1", 10, 5, "TypeScript"),
            createRepoContribution("repo2", 10, 5, null),
          ],
          [],
        ),
        createYearData(
    ...
    it("sums all components correctly with weights", () => {
      const timeline = [
        ...
        createYearData(
          2024,
          100,
          [createRepoContribution("repo1", 100, 20, "TypeScript")],
          [],
        ),
      ];
      const result = calculateGrowthScore(timeline);
      ...
      const expectedScore =
        result.breakdown.activityGrowth +
        result.breakdown.impactGrowth +
        result.breakdown.skillsGrowth;
    ...
    it("rounds score to nearest integer", () => {
      const timeline = [
        createYearData(
          2025,
          150,
          [createRepoContribution("repo1", 120, 25)],
          [],
        ),
        createYearData(
          2024,
    ...
    it("calculates stable correctly", () => {
      const timeline = [
        createYearData(
          2025,
          105,
          [createRepoContribution("repo1", 105, 21)],
          [],
        ),
        createYearData(
          2024,
    ...
    it("ensures impact growth never exceeds 30", () => {
      const timeline = [
        createYearData(
          2025,
          100,
          [createRepoContribution("repo1", 100000, 10000)],
          [],
        ),
        createYearData(
          2024,
      ...
      const timeline = [
        createYearData(
          ...
          languages.map((lang, i) =>
            createRepoContribution(`repo${i}`, 10, 5, lang),
          ),
          [],
        ),
        createYearData(
    ...
    it("ensures total score never exceeds 100", () => {
      ...
      const timeline = [
        createYearData(
          ...
          100000,
          languages.map((lang, i) =>
            createRepoContribution(`repo${i}`, 10000, 1000, lang),
          ),
          [],
        ),
        createYearData(
          2024,
          100,
          [createRepoContribution("repo1", 100, 10, "TypeScript")],
          [],
        ),
      ];
      const result = calculateGrowthScore(timeline);
