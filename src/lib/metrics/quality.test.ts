...
describe('calculateQualityScore', () => {
    ...
    it('awards full 30 points for 100% non-fork repos', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [
            createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, true, fiveYearsAgo, 'JavaScript'),
          ],
          []
        ),
      ];
    ...
    it('awards proportional points for partial non-fork ratio', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [
            createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript'), // original
            createRepoContribution('repo2', true, true, fiveYearsAgo, 'JavaScript'), // fork
          ],
          []
        ),
      ];
    ...
    it('awards 0 points for 100% fork repos', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [
            createRepoContribution('repo1', true, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', true, true, fiveYearsAgo, 'JavaScript'),
          ],
          []
        ),
      ];
      ...
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, true, fiveYearsAgo, 'JavaScript'),
            createRepoContribution('repo3', false, true, fiveYearsAgo, 'Python'),
  ...
  describe('documentation component (0-25 points)', () => {
    ...
    it('awards proportional points for partial documentation', () => {
      ...
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, false, fiveYearsAgo, 'JavaScript'),
          ],
          []
        ),
      ];
    ...
    it('awards 0 points for no documented repos', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [
            createRepoContribution('repo1', false, false, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, false, fiveYearsAgo, 'JavaScript'),
          ],
          []
        ),
    ...
    it('handles empty descriptions as undocumented', () => {
      const fiveYearsAgo = new Date(Date.now() - 5 * 365 * 24 * 60 * 60 * 1000).toISOString();
      const repo = createRepoContribution('repo1', false, false, fiveYearsAgo, 'TypeScript');
    ...
    it('awards proportional points for mixed ownership', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript')],
          [createRepoContribution('contrib1', false, true, fiveYearsAgo, 'JavaScript')]
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('awards lower points for more contributions than owned', () => {
      ...
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution('contrib1', false, true, fiveYearsAgo, 'JavaScript'),
            createRepoContribution('contrib2', false, true, fiveYearsAgo, 'Python'),
  ...
  describe('maturity component (0-15 points)', () => {
    it('awards 15 points for 5+ year average age', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, sixYearsAgo, 'TypeScript')],
          []
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('awards 12 points for 3-5 year average age', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, fourYearsAgo, 'TypeScript')],
          []
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('awards 9 points for 2-3 year average age', () => {
      const twoHalfYearsAgo = new Date(Date.now() - 2.5 * 365 * 24 * 60 * 60 * 1000).toISOString();
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, twoHalfYearsAgo, 'TypeScript')],
          []
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('awards 6 points for 1-2 year average age', () => {
      const oneHalfYearsAgo = new Date(Date.now() - 1.5 * 365 * 24 * 60 * 60 * 1000).toISOString();
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, oneHalfYearsAgo, 'TypeScript')],
          []
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('awards 3 points for < 1 year average age', () => {
      const sixMonthsAgo = new Date(Date.now() - 0.5 * 365 * 24 * 60 * 60 * 1000).toISOString();
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, sixMonthsAgo, 'TypeScript')],
          []
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('calculates average age correctly across multiple repos', () => {
      ...
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, true, oneYearAgo, 'JavaScript'),
          ],
          []
        ),
      ];
      ...
      const timeline = [
        createYearData(
          ...
          [
            ...
            createRepoContribution('repo10', false, true, fiveYearsAgo, 'Swift'),
          ],
          []
        ),
      ];
    ...
    it('deduplicates same language across multiple repos', () => {
      ...
      const timeline = [
        createYearData(
          ...
          [
            createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, true, fiveYearsAgo, 'TypeScript'),
            createRepoContribution('repo3', false, true, fiveYearsAgo, 'TypeScript'),
          ],
          []
        ),
      ];
  ...
  describe('score calculation', () => {
    ...
    it('rounds score to nearest integer', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, fourYearsAgo, 'TypeScript')],
          [createRepoContribution('contrib1', false, true, fourYearsAgo, 'JavaScript')]
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('calculates strong quality correctly', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [
            createRepoContribution('repo1', false, true, threeYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', false, true, threeYearsAgo, 'JavaScript'),
            createRepoContribution('repo3', true, false, threeYearsAgo, 'Python'), // fork
          ],
          [createRepoContribution('contrib1', false, true, threeYearsAgo, 'Go')]
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('calculates good quality correctly', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [
            createRepoContribution('repo1', false, true, twoYearsAgo, 'TypeScript'),
            createRepoContribution('repo2', true, false, twoYearsAgo, 'JavaScript'), // fork
          ],
          [createRepoContribution('contrib1', false, true, twoYearsAgo, 'Python')]
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('calculates fair quality correctly', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', true, false, oneYearAgo, 'TypeScript')], // fork, no docs
          [
            createRepoContribution('contrib1', false, true, oneYearAgo, 'JavaScript'),
            createRepoContribution('contrib2', false, true, oneYearAgo, 'Python'),
          ]
        ),
      ];
      const result = calculateQualityScore(timeline);
    ...
    it('calculates weak quality correctly', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [],
          [createRepoContribution('contrib1', true, false, sixMonthsAgo, 'JavaScript')]
        ),
      ];
      const result = calculateQualityScore(timeline);
  ...
  describe('deduplication across years', () => {
    it('deduplicates same repo across multiple years', () => {
      const fiveYearsAgo = new Date(Date.now() - 5 * 365 * 24 * 60 * 60 * 1000).toISOString();
      const repo = createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript');
      const timeline = [
    ...
    it('counts different repos with same name separately', () => {
      const fiveYearsAgo = new Date(Date.now() - 5 * 365 * 24 * 60 * 60 * 1000).toISOString();
      const repo1 = createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript');
      const repo2 = createRepoContribution('repo1', false, true, fiveYearsAgo, 'TypeScript');
  ...
  describe('breakdown constraints', () => {
      ...
      const timeline = [
        createYearData(
          ...
          Array.from({ length: 50 }, (_, i) =>
            createRepoContribution(`repo${i}`, false, true, fiveYearsAgo, 'TypeScript')
          ),
          []
        ),
      ];
    ...
    it('ensures maturity never exceeds 15', () => {
      ...
      const timeline = [
        createYearData(
          2025,
          [createRepoContribution('repo1', false, true, tenYearsAgo, 'TypeScript')],
          []
        ),
      ];
      const result = calculateQualityScore(timeline);
