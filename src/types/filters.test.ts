...
describe('Filter Types', () => {
  ...
  describe('RepositoryFilter', () => {
    ...
    it('should have optional boolean properties', () => {
      expectTypeOf<RepositoryFilter>().toHaveProperty('originalOnly').toEqualTypeOf<boolean | undefined>();
      expectTypeOf<RepositoryFilter>().toHaveProperty('forksOnly').toEqualTypeOf<boolean | undefined>();
      expectTypeOf<RepositoryFilter>().toHaveProperty('hideArchived').toEqualTypeOf<boolean | undefined>();
      expectTypeOf<RepositoryFilter>().toHaveProperty('hasTopics').toEqualTypeOf<boolean | undefined>();
      expectTypeOf<RepositoryFilter>().toHaveProperty('hasLicense').toEqualTypeOf<boolean | undefined>();
    });

    it('should have optional string properties', () => {
      expectTypeOf<RepositoryFilter>().toHaveProperty('language').toEqualTypeOf<string | undefined>();
      expectTypeOf<RepositoryFilter>().toHaveProperty('searchQuery').toEqualTypeOf<string | undefined>();
    });

    it('should have optional number property', () => {
      expectTypeOf<RepositoryFilter>().toHaveProperty('minStars').toEqualTypeOf<number | undefined>();
    });
  });
  ...
  describe('RepositorySorting', () => {
    ...
    it('should have field of type SortBy', () => {
      expectTypeOf<RepositorySorting>().toHaveProperty('field').toEqualTypeOf<SortBy>();
    });

    it('should have direction of type SortDirection', () => {
      expectTypeOf<RepositorySorting>().toHaveProperty('direction').toEqualTypeOf<SortDirection>();
    });
  ...
  describe('Type relationships', () => {
    ...
    it('should use SortDirection in RepositorySorting', () => {
      expectTypeOf<RepositorySorting['direction']>().toEqualTypeOf<SortDirection>();
    });
  });
});
