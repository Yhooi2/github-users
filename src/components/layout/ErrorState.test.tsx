...
describe('ErrorState', () => {
  describe('rendering', () => {
    ...
    it('should render different variants', () => {
      const { rerender } = render(<ErrorState message="Test" variant="error" />);
      expect(screen.getByRole('alert')).toBeInTheDocument();
  ...
  describe('icons', () => {
    it('should show error icon by default', () => {
      const { container } = render(<ErrorState message="Test" variant="error" />);
    ...
    it('should show warning icon for warning variant', () => {
      const { container } = render(<ErrorState message="Test" variant="warning" />);
    ...
    it('should show info icon for info variant', () => {
      const { container } = render(<ErrorState message="Test" variant="info" />);
    ...
    it('should not show icon when showIcon is false', () => {
      const { container } = render(<ErrorState message="Test" showIcon={false} />);
  ...
  describe('retry action', () => {
    ...
    it('should render custom retry text', () => {
      const handleRetry = vi.fn();
      render(<ErrorState message="Test" onRetry={handleRetry} retryText="Custom Retry" />);
  ...
  describe('dismiss action', () => {
    ...
    it('should render custom dismiss text', () => {
      const handleDismiss = vi.fn();
      render(<ErrorState message="Test" onDismiss={handleDismiss} dismissText="Close" />);
  ...
  describe('both actions', () => {
    it('should render both retry and dismiss buttons', () => {
      const handleRetry = vi.fn();
      const handleDismiss = vi.fn();
      render(<ErrorState message="Test" onRetry={handleRetry} onDismiss={handleDismiss} />);
