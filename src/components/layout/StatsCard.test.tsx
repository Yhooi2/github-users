...
describe('StatsCard', () => {
  ...
  it('should render with icon', () => {
    const { container } = render(<StatsCard title="Followers" value={100} icon={Users} />);
    expect(container.querySelector('svg')).toBeInTheDocument();
  });

  it('should render description', () => {
    render(<StatsCard title="Followers" value={100} description="Total followers" />);
  ...
  it('should render trend neutral', () => {
    const { container } = render(
      <StatsCard title="Followers" value={100} trend="neutral" trendValue="0%" />
    );
  ...
  it('should render badge', () => {
    render(<StatsCard title="Followers" value={100} badge={<span>New</span>} />);
    expect(screen.getByText('New')).toBeInTheDocument();
  });

  it('should render footer', () => {
    render(<StatsCard title="Followers" value={100} footer={<div>Footer content</div>} />);
