...
describe("MetricExplanationModal", () => {
  ...
  it("displays impact metric details", () => {
    ...
    expect(
      screen.getByText("Measures community reach and engagement"),
    ).toBeInTheDocument();
    expect(screen.getByText("30 pts")).toBeInTheDocument();
  ...
  it("displays quality metric details", () => {
    ...
    expect(
      screen.getByText("Evaluates code quality, documentation, and maturity"),
    ).toBeInTheDocument();
    expect(screen.getByText("30 pts")).toBeInTheDocument();
  ...
  it("displays growth metric details", () => {
    ...
    expect(
      screen.getByText("Tracks year-over-year improvement in contributions"),
    ).toBeInTheDocument();
