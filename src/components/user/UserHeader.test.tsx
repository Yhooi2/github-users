...
describe('UserHeader', () => {
  describe('Rendering', () => {
    ...
    it('should fall back to login when name is null', () => {
      ...
      expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent('octocat');
    });
    ...
    it('should render bio when available', () => {
      render(<UserHeader user={mockUser} />);
      expect(screen.getByText('GitHub mascot and friendly feline')).toBeInTheDocument();
    });

    it('should not render bio when null', () => {
      const userWithoutBio = { ...mockUser, bio: null };
      render(<UserHeader user={userWithoutBio} />);
      expect(screen.queryByText('GitHub mascot and friendly feline')).not.toBeInTheDocument();
    });
  ...
  describe('Date Formatting', () => {
    ...
    it('should handle different date formats', () => {
      const userWithDifferentDate = { ...mockUser, createdAt: '2024-06-15T10:30:00Z' };
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle special characters in location', () => {
      const userWithSpecialLocation = { ...mockUser, location: 'São Paulo, Brazil 🇧🇷' };
