...
describe('ActivityChart', () => {
  ...
  describe('Rendering', () => {
    it('should render chart with data', () => {
      ...
      expect(screen.getByText(/average commits per time period/i)).toBeInTheDocument();
    });
  ...
  describe('Error State', () => {
    ...
    it('should show custom error title and description', () => {
      ...
      expect(screen.getByText('Not enough data to calculate statistics')).toBeInTheDocument();
    });
  ...
  describe('Empty State', () => {
    it('should show empty state when data is null', () => {
      ...
      expect(screen.getByText('No commit activity statistics available.')).toBeInTheDocument();
    });
    ...
    it('should show custom empty title and description', () => {
      ...
      expect(screen.getByText('Start contributing to see statistics')).toBeInTheDocument();
    });
  });
  ...
  describe('State Priority', () => {
    it('should show loading state over error state', () => {
      ...
      expect(screen.getByText('Loading activity statistics...')).toBeInTheDocument();
      expect(screen.queryByText('Failed to load activity statistics')).not.toBeInTheDocument();
    });
