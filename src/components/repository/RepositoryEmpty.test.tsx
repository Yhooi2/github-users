...
describe("RepositoryEmpty", () => {
  describe("Rendering", () => {
    it("should render with default props", () => {
      ...
      expect(
        screen.getByText(
          "No repositories match the current filters. Try adjusting your search criteria.",
        ),
      ).toBeInTheDocument();
    });
    ...
    it("should render with both custom title and description", () => {
      ...
      expect(
        screen.getByText("You haven't starred any repositories yet."),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Filter States", () => {
    ...
    it("should show no-repos message when hasFilters is false", () => {
      ...
      expect(
        screen.queryByText("No repositories match the current filters"),
      ).not.toBeInTheDocument();
    });
    ...
    it("should override description even when hasFilters is false", () => {
      ...
      render(
        <RepositoryEmpty hasFilters={false} description={customDescription} />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle very long title", () => {
      const longTitle =
        "This is a very long title that might cause layout issues in some cases but should still render properly".repeat(
          2,
        );
    ...
    it("should handle very long description", () => {
      const longDescription =
        "This is a very long description that contains a lot of text and might wrap multiple lines in the UI. ".repeat(
          5,
        );
      render(
        <RepositoryEmpty description={longDescription} hasFilters={true} />,
      );
  ...
  describe("Props Combinations", () => {
    it("should work with all props provided", () => {
      ...
      expect(
        screen.getByText("Testing all props together"),
      ).toBeInTheDocument();
    });
