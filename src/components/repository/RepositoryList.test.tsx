...
describe("RepositoryList", () => {
  ...
  describe("Click Handling", () => {
    it("should call onRepositoryClick when a repository is clicked", async () => {
      ...
      const firstRepo = screen.getByRole("button", {
  ...
  describe("Accessibility", () => {
    it("should have accessible list role", () => {
      ...
      expect(
        screen.getByRole("list", { name: "Repository list" }),
      ).toBeInTheDocument();
    });
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle undefined error gracefully", () => {
      render(
        <RepositoryList repositories={mockRepositories} error={undefined} />,
      );
    ...
    it("should handle loading=false explicitly", () => {
      render(
        <RepositoryList repositories={mockRepositories} loading={false} />,
      );
