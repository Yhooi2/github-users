...
describe('RepositoryCard', () => {
  ...
  describe('Fork Badge', () => {
    ...
    it('should not render fork badge when repository is not a fork', () => {
      ...
      expect(screen.queryByLabelText('This repository is a fork')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Archived Badge', () => {
    ...
    it('should not render archived badge when repository is not archived', () => {
      ...
      expect(screen.queryByLabelText('This repository is archived')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Click Handling', () => {
    it('should call onClick when card is clicked', async () => {
      ...
      render(<RepositoryCard repository={mockRepository} onClick={handleClick} />);

      const card = screen.getByRole('button', { name: /Open test-repo repository/i });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle repository with both fork and archived badges', () => {
      ...
      expect(screen.getByLabelText('This repository is a fork')).toBeInTheDocument();
      expect(screen.getByLabelText('This repository is archived')).toBeInTheDocument();
    });
  });
