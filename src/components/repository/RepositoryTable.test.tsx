...
describe("RepositoryTable", () => {
  ...
  describe("Loading State", () => {
    ...
    it("should not show table when loading", () => {
      render(
        <RepositoryTable repositories={mockRepositories} loading={true} />,
      );
  ...
  describe("Empty State", () => {
    ...
    it("should show no-repos message when hasActiveFilters is false", () => {
      ...
      expect(
        screen.getByText(
          /This user hasn't created any public repositories yet/i,
        ),
      ).toBeInTheDocument();
    });
  ...
  describe("Click Handling", () => {
    it("should call onRepositoryClick when a row is clicked", async () => {
      ...
      const firstRow = screen.getByRole("button", {
        name: /Open test-repo-1 repository/i,
      });
  ...
  describe("State Priority", () => {
    it("should show loading state over error state", () => {
      const error = new Error("Test error");
      render(
        <RepositoryTable repositories={[]} loading={true} error={error} />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle undefined error gracefully", () => {
      render(
        <RepositoryTable repositories={mockRepositories} error={undefined} />,
      );
    ...
    it("should handle loading=false explicitly", () => {
      render(
        <RepositoryTable repositories={mockRepositories} loading={false} />,
      );
