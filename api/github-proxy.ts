...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (finalCacheKey && kv) {
    try {
      ...
      console.warn('KV cache read failed:', error instanceof Error ? error.message : 'Unknown error')
  ...
  try {
    ...
    if (finalCacheKey && kv) {
      try {
        ...
        console.warn('KV cache write failed:', error instanceof Error ? error.message : 'Unknown error')
